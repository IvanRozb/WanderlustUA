...
public interface IRouteTouristPlaceService
{
    ...
    Task<RouteTouristPlaceDto> GetByIdAsync(Guid userId, Guid routeId, Guid touristPlaceId, Guid routeTouristPlaceId, CancellationToken cancellationToken = default);
    Task<RouteTouristPlaceDto> CreateAsync(Guid userId, Guid routeId, Guid touristPlaceId,
        RouteTouristPlaceForCreatingDto routeForCreationDto, CancellationToken cancellationToken = default);
